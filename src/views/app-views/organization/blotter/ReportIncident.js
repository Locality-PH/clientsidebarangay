...
const ReportIncident = ({ organizationId }) => {
  ...
  const onFinish = () => {
    form
      ...
      .then((values) => {
        if (
          values.victimsInvolve == "undefined" ||
          values.victimsInvolve.length == 0 ||
          values.suspectsInvolve == "undefined" ||
          values.suspectsInvolve.length == 0 ||
          values.respondentsInvolve == "undefined" ||
          values.respondentsInvolve.length == 0
        ) {
                      ...
                      <div className="mb-2 text-justify text-justify-content-center">
                        <i>
                          ...
                          <label style={{ color: "red" }}>
                            ENTER IN DETAIL THE NARRATIVE OF THE INCIDENT OR
                            EVENT, ANSWERING THE WHO, WHAT, WHEN, WHERE, WHY,
                      ...
                      <Col span="24">
                        ...
                        >
                          <Select className="w-100" placeholder="Incident">
                            <Option key="1" value="Positive Observations">
                              Positive Observations
                            </Option>
                            <Option key="2" value="Unsafe Acts">
                              Unsafe Acts
                            </Option>
                            <Option key="3" value="Near Misses">
                              Near Misses
                            </Option>
                            <Option key="4" value="Minor Injuries">
                              Minor Injuries
                            </Option>
                            <Option key="5" value="Lost Time Accidents">
                              Lost Time Accidents
                            </Option>
                            <Option key="6" value="Fatalities">
                              Fatalities
                            </Option>
                          </Select>
                        </Form.Item>
