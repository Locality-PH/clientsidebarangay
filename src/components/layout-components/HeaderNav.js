...
import { MenuFoldOutlined, MenuUnfoldOutlined, SearchOutlined, MessageFilled} from '@ant-design/icons';
...
export const HeaderNav = props => {
  ...
  return (
    <Header className={`app-header ${navMode}`} style={{ backgroundColor: "#24292f", height: "6rem" }}>
